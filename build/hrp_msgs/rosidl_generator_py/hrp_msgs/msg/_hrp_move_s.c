...
bool hrp_msgs__msg__hrp_move__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "hrp_msgs.msg._hrp_move.HrpMove",
        full_classname_dest, 30) == 0);
  }
  hrp_msgs__msg__HrpMove * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of HrpMove */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hrp_msgs.msg._hrp_move");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HrpMove");
