...
#include "hrp_msgs/msg/hrp_move__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const hrp_msgs::msg::HrpMove *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hrp_msgs::msg::HrpMove *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HrpMove__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const hrp_msgs::msg::HrpMove *>(
...
{
  return max_serialized_size_HrpMove(full_bounded, 0);
}

static message_type_support_callbacks_t _HrpMove__callbacks = {
  "hrp_msgs::msg",
  "HrpMove",
...
static rosidl_message_type_support_t _HrpMove__handle = {
...
{
  return &hrp_msgs::msg::typesupport_fastrtps_cpp::_HrpMove__handle;
}
